...
describe('Gilded Rose', () => {
  ...
  describe('update quality', () => {
    //first statement, excluding Sulfuras
    ...
    describe('when items increase quality while getting older', () => {
      //start part items that increase in Q
      ...
      //end items increase Q
    });

    describe('when items decrease quality while getting older', () => {
      //start items decrease Q
